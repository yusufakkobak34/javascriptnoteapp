...
addBox.addEventListener("click", () => {
    popupTitle.innerText = "Yeni Not Ekle";
...
function deleteNote(noteId) {
    let confirmDel = confirm("Notu silmek istediğinize emin misiniz ?");
...
function updateNote(noteId, title, filterDesc) {
    ...
    popupTitle.innerText = "Bir notu güncelleyin";
    addBtn.innerText = "Notu güncelle";
}
